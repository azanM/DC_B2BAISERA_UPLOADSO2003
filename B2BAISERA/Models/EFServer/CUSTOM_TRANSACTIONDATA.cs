...
namespace B2BAISERA.Models.EFServer
{
    public partial class CUSTOM_TRANSACTIONDATA
    {
        ...
        public virtual ICollection<CUSTOM_S02003> CUSTOM_S02003
        {
            get
            {
                if (_cUSTOM_S02003 == null)
                {
                    var newCollection = new FixupCollection<CUSTOM_S02003>();
                    newCollection.CollectionChanged += FixupCUSTOM_S02003;
                    _cUSTOM_S02003 = newCollection;
                }
                return _cUSTOM_S02003;
            }
            set
            {
                if (!ReferenceEquals(_cUSTOM_S02003, value))
                {
                    var previousValue = _cUSTOM_S02003 as FixupCollection<CUSTOM_S02003>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupCUSTOM_S02003;
                    }
                    _cUSTOM_S02003 = value;
                    var newValue = value as FixupCollection<CUSTOM_S02003>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupCUSTOM_S02003;
                    }
                }
            }
        }
        private ICollection<CUSTOM_S02003> _cUSTOM_S02003;
        ...
        private void FixupCUSTOM_S02003(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (CUSTOM_S02003 item in e.NewItems)
                {
                    item.CUSTOM_TRANSACTIONDATA = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (CUSTOM_S02003 item in e.OldItems)
                {
                    if (ReferenceEquals(item.CUSTOM_TRANSACTIONDATA, this))
                    {
                        item.CUSTOM_TRANSACTIONDATA = null;
