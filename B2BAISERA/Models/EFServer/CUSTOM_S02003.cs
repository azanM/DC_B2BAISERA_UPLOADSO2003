...
{
    public partial class CUSTOM_S02003
    {
        ...
        {
            if (previousValue != null && previousValue.CUSTOM_S02003.Contains(this))
            {
                previousValue.CUSTOM_S02003.Remove(this);
            }
    
            if (CUSTOM_TRANSACTIONDATA != null)
            {
                if (!CUSTOM_TRANSACTIONDATA.CUSTOM_S02003.Contains(this))
                {
                    CUSTOM_TRANSACTIONDATA.CUSTOM_S02003.Add(this);
                }
